...
HD_PWD='C:/Repos/ug3-seeg/ug3-seeg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cable_delay_tester_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cable_delay_tester_wrapper.tcl
