...
HD_PWD='C:/Repos/ug3-seeg/ug3-seeg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cable_delay_tester_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cable_delay_tester_wrapper.tcl -notrace
