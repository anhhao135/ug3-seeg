...
HD_PWD='C:/Repos/ug3-seeg/ug3-seeg.runs/fifo_rhd_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_rhd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_rhd.tcl
