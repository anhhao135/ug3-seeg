...
HD_PWD='C:/Repos/ug3-seeg/ug3-seeg.runs/cable_delay_tester_jtag_axi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cable_delay_tester_jtag_axi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cable_delay_tester_jtag_axi_0_0.tcl
