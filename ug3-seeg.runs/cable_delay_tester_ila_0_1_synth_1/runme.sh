...
HD_PWD='C:/Repos/ug3-seeg/ug3-seeg.runs/cable_delay_tester_ila_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cable_delay_tester_ila_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cable_delay_tester_ila_0_1.tcl
