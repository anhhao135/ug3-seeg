...
module cable_delay_tester_rhd_2048_0_0(rstn, clk, config_start, record_start, 
  zcheck_start, zcheck_global_channel, zcheck_scale, fifo_read_en_zcheck, 
  fifo_valid_out_zcheck, data_fifo_out_zcheck, busy, done, oversample_offset_A1, 
  ...
  oversample_offset_O2, oversample_offset_P1, oversample_offset_P2, fifo_read_en, 
  fifo_write_en_ext, fifo_rst, fifo_valid_out, data_fifo_out_1, data_fifo_out_2, CS, SCLK, MOSI, 
  MISO1_A, MISO2_A, MISO1_B, MISO2_B, MISO1_C, MISO2_C, MISO1_D, MISO2_D, MISO1_E, MISO2_E, MISO1_F, 
  MISO2_F, MISO1_G, MISO2_G, MISO1_H, MISO2_H, MISO1_I, MISO2_I, MISO1_J, MISO2_J, MISO1_K, MISO2_K, 
  MISO1_L, MISO2_L, MISO1_M, MISO2_M, MISO1_N, MISO2_N, MISO1_O, MISO2_O, MISO1_P, MISO2_P, 
  channel_out, sampling_rate_20k)
/* synthesis syn_black_box black_box_pad_pin="rstn,config_start,record_start,zcheck_start,zcheck_global_channel[11:0],zcheck_scale[1:0],fifo_read_en_zcheck,fifo_valid_out_zcheck,data_fifo_out_zcheck[63:0],busy,done,oversample_offset_A1[7:0],oversample_offset_A2[7:0],oversample_offset_B1[7:0],oversample_offset_B2[7:0],oversample_offset_C1[7:0],oversample_offset_C2[7:0],oversample_offset_D1[7:0],oversample_offset_D2[7:0],oversample_offset_E1[7:0],oversample_offset_E2[7:0],oversample_offset_F1[7:0],oversample_offset_F2[7:0],oversample_offset_G1[7:0],oversample_offset_G2[7:0],oversample_offset_H1[7:0],oversample_offset_H2[7:0],oversample_offset_I1[7:0],oversample_offset_I2[7:0],oversample_offset_J1[7:0],oversample_offset_J2[7:0],oversample_offset_K1[7:0],oversample_offset_K2[7:0],oversample_offset_L1[7:0],oversample_offset_L2[7:0],oversample_offset_M1[7:0],oversample_offset_M2[7:0],oversample_offset_N1[7:0],oversample_offset_N2[7:0],oversample_offset_O1[7:0],oversample_offset_O2[7:0],oversample_offset_P1[7:0],oversample_offset_P2[7:0],fifo_read_en,fifo_write_en_ext,fifo_rst,fifo_valid_out,data_fifo_out_1[63:0],data_fifo_out_2[63:0],CS,MOSI,MISO1_A,MISO2_A,MISO1_B,MISO2_B,MISO1_C,MISO2_C,MISO1_D,MISO2_D,MISO1_E,MISO2_E,MISO1_F,MISO2_F,MISO1_G,MISO2_G,MISO1_H,MISO2_H,MISO1_I,MISO2_I,MISO1_J,MISO2_J,MISO1_K,MISO2_K,MISO1_L,MISO2_L,MISO1_M,MISO2_M,MISO1_N,MISO2_N,MISO1_O,MISO2_O,MISO1_P,MISO2_P,channel_out[7:0],sampling_rate_20k" */
...
/* synthesis syn_force_seq_prim="SCLK" */;
  ...
  input fifo_read_en_zcheck;
  output fifo_valid_out_zcheck;
  output [63:0]data_fifo_out_zcheck;
  output busy;
  output done;
  ...
  input fifo_read_en;
  input fifo_write_en_ext;
  input fifo_rst;
  output fifo_valid_out;
  output [63:0]data_fifo_out_1;
  output [63:0]data_fifo_out_2;
  output CS;
