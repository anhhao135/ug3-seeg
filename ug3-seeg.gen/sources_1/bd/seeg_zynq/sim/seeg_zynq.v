...
module seeg_zynq
  ...
  wire seeg_top_0_RHD_miso_post_delay_debug_out;
  ...
  wire seeg_top_0_led_signal_out;
  ...
  assign led_signal_out = seeg_top_0_led_signal_out;
  ...
  seeg_zynq_seeg_top_0_0 seeg_top_0
       (.M_AXIS_ACLK(clk_wiz_0_clk_39M),
        ...
        .RHD_miso_post_delay_debug_out(seeg_top_0_RHD_miso_post_delay_debug_out),
        ...
        .aux_signal(1'b0),
        .led_signal_out(seeg_top_0_led_signal_out));
  ...
  seeg_zynq_system_ila_0_0 system_ila_0
       (.clk(clk_wiz_0_clk_39M),
        ...
        .probe8(RHS_MISO_A_1),
        .probe9(seeg_top_0_RHD_miso_post_delay_debug_out));
