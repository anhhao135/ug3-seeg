...
#
# Script generated by Vivado on Wed Sep 18 12:28:24 -0700 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : axis_data_fifo_seeg.sh
...
#
# Usage        : axis_data_fifo_seeg.sh
#                axis_data_fifo_seeg.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axis_data_fifo_seeg.sh [-reset_run]
#                axis_data_fifo_seeg.sh [-reset_log]
#                axis_data_fifo_seeg.sh [-help]
#
...
# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_14 -L xilinx_vip"

# script info
echo -e "axis_data_fifo_seeg.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axis_data_fifo_seeg.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axis_infrastructure_v1_1_0 -L axis_data_fifo_v2_0_10 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axis_data_fifo_seeg xil_defaultlib.axis_data_fifo_seeg xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axis_data_fifo_seeg -key {Behavioral:seeg_top:Functional:axis_data_fifo_seeg} -tclbatch cmd.tcl -protoinst "protoinst_files/tb_seeg_top.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axis_data_fifo_seeg.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axis_data_fifo_seeg.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axis_data_fifo_seeg.sh [-help]\n\
Usage: axis_data_fifo_seeg.sh [-step]\n\
Usage: axis_data_fifo_seeg.sh [-lib_map_path]\n\
Usage: axis_data_fifo_seeg.sh [-reset_run]\n\
Usage: axis_data_fifo_seeg.sh [-reset_log]\n\
Usage: axis_data_fifo_seeg.sh [-keep_index]\n\
Usage: axis_data_fifo_seeg.sh [-noclean_files]\n\n\
