...
design_libs=(xilinx_vip xpm xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_14 zynq_ultra_ps_e_vip_v1_0_14 lib_cdc_v1_0_2 proc_sys_reset_v5_0_13 xlconstant_v1_1_7 jtag_axi)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.cable_delay_tester xil_defaultlib.glbl -o cable_delay_tester_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./cable_delay_tester_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key cable_delay_tester_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc cable_delay_tester_simv.daidir vcs_lib c.obj)
