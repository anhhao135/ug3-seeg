...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axi_infrastructure_v1_1_0 -L xil_defaultlib -L axi_vip_v1_1_14 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot tb_seeg_top xil_defaultlib.tb_seeg_top xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tb_seeg_top -key {Behavioral:seeg:Functional:tb_seeg_top} -tclbatch cmd.tcl -protoinst "protoinst_files/cable_delay_tester.protoinst" -protoinst "protoinst_files/jtag_axi_test.protoinst" -protoinst "protoinst_files/tb_seeg_top.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tb_seeg_top.wdb xsim.dir libdpi.so)
