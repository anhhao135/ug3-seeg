...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_14 -L zynq_ultra_ps_e_vip_v1_0_14 -L xil_defaultlib -L jtag_axi -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot jtag_axi_test xil_defaultlib.jtag_axi_test xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim jtag_axi_test -key {Behavioral:seeg:Functional:jtag_axi_test} -tclbatch cmd.tcl -protoinst "protoinst_files/cable_delay_tester.protoinst" -protoinst "protoinst_files/jtag_axi_test.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb jtag_axi_test.wdb xsim.dir libdpi.so)
