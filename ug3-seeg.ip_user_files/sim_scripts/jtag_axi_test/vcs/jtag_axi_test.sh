...
design_libs=(xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_14 zynq_ultra_ps_e_vip_v1_0_14 xil_defaultlib jtag_axi lib_cdc_v1_0_2 proc_sys_reset_v5_0_13)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.jtag_axi_test xil_defaultlib.glbl -o jtag_axi_test_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./jtag_axi_test_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key jtag_axi_test_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc jtag_axi_test_simv.daidir vcs_lib c.obj)
