...
#
# Script generated by Vivado on Wed Sep 11 09:40:52 -0700 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : jtag_axi_test.sh
...
#
# Usage        : jtag_axi_test.sh
#                jtag_axi_test.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                jtag_axi_test.sh [-reset_run]
#                jtag_axi_test.sh [-reset_log]
#                jtag_axi_test.sh [-help]
#
...
#                script (type 'jtag_axi_test.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_14 -libname zynq_ultra_ps_e_vip_v1_0_14 -libname xil_defaultlib -libname jtag_axi -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_13 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_14 zynq_ultra_ps_e_vip_v1_0_14 xil_defaultlib jtag_axi lib_cdc_v1_0_2 proc_sys_reset_v5_0_13)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "jtag_axi_test.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./jtag_axi_test.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$ref_dir/../../../../ug3-seeg.gen/sources_1/bd/jtag_axi_test/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../ug3-seeg.gen/sources_1/bd/jtag_axi_test/ipshared/f805/hdl" +incdir+"$ref_dir/../../../../ug3-seeg.gen/sources_1/bd/jtag_axi_test/ipshared/30ef" +incdir+"../../../../ug3-seeg.gen/sources_1/bd/jtag_axi_test/ipshared/ec67/hdl" +incdir+"../../../../ug3-seeg.gen/sources_1/bd/jtag_axi_test/ipshared/f805/hdl" +incdir+"../../../../ug3-seeg.gen/sources_1/bd/jtag_axi_test/ipshared/30ef" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.jtag_axi_test xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.jtag_axi_test -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log jtag_axi_test_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./jtag_axi_test.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: jtag_axi_test.sh [-help]\n\
Usage: jtag_axi_test.sh [-step]\n\
Usage: jtag_axi_test.sh [-lib_map_path]\n\
Usage: jtag_axi_test.sh [-reset_run]\n\
Usage: jtag_axi_test.sh [-reset_log]\n\
Usage: jtag_axi_test.sh [-keep_index]\n\
Usage: jtag_axi_test.sh [-noclean_files]\n\n\
